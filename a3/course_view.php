...
<section>
  ...
  <div class="input-group-append">
    ...
    <?php
      $obj = new Questions;
      $resultset = $obj->get_search($_GET['id']);
      ...
      <div class="main">
          ...
          <button type="submit" class="btn btn-link" value="<?php echo $row['question_id'] ?>" name="id">Read More</button>
          </form></p>
            </div>
            </div>
      <?php }?>
...
<select name="tag" class="form-control">
  ...
  <div class="input-group-append">
    <button class="btn btn-outline-primary" type="submit">Search</button>
          ...
          <h5 class="card-title text-center display-4"><?php echo $resultset['courseName']; ?></h5>
          <p class="text-center">
          <br>
          </p>
        </div>
